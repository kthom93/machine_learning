...
from .neural_net import NeuralNetLearner
from .decision_tree import DecisionTreeLearner
from .nearest_neighbor import InstanceBasedLearner
from .k_means import KMeansLearner
...
class MLSystemManager:
    ...
    def parser(self):
        ...
        parser.add_argument('-L', required=True, choices=['baseline', 'perceptron', 'neuralnet', 'decisiontree', 'knn', 'kmeans'], help='Learning Algorithm')
